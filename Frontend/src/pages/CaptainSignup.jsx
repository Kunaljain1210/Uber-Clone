    ...
    <div>
      <div className='p-7 h-screen flex flex-col justify-between'>
        <div>
          ...
          <div className='w-42 h-7 rounded m-auto mb-3.5 font-semibold bg-green-300'>
            <p className='w-38 m-4'>SignUp As Captain</p>
          </div>
          ...
          <h3 className='text-lg mb-2 font-medium'>What's our Captain Name</h3>
            ...
            <h3 className='text-base mb-2'>What's our Captain Email</h3>
            <input 
              required
            ...
            <h3 className='text-base mb-2'>Captain Password</h3>
            <input 
              required
